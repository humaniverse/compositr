...
compositr makes it easy to create composite scores and build indices. It does
this by providing a suite of functions that allow you to combine and manipulate
indicators in various different ways.
...
example on [GitHub](https://github.com/britishredcrosssociety/compositr/issues).
